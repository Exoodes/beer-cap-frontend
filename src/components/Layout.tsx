import { AppShell, Burger, Button, Container, Group, Title, Badge } from "@mantine/core";
  ...
  return (
    ...
    >
      ...
      <AppShell.Navbar p="md">
        <Button component={Link} to="/" variant="subtle" onClick={toggle} mb="xs">
          Dashboard
        </Button>
        {isAdmin && (
          <>
            <Button component={Link} to="/add" variant="subtle" onClick={toggle} mb="xs">
              Add Cap
            </Button>
